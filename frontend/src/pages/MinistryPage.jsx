    ...
    <div>
      ...
      <div style={{ 
        ...
        <div style={{position: 'relative', zIndex: 1, textAlign: 'center', color: 'white', padding: '20px'}}>
          ...
          <p style={{fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto'}}>{description}</p>
        </div>
      </div>
      ...
      <div className="container" style={{padding: '40px 20px'}}>
        <div style={{display: 'flex', gap: '40px', flexWrap: 'wrap'}}>
          ...
          <div style={{flex: 2, minWidth: '300px'}}>
            <h2 style={{color: 'var(--church-blue)', borderBottom: '2px solid var(--church-gold)', display: 'inline-block', marginBottom: '20px'}}>
              Latest Updates & News
            </h2>
          ...
          <div style={{flex: 1, minWidth: '250px'}}>
            <div style={{backgroundColor: 'white', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 5px rgba(0,0,0,0.1)', borderTop: '4px solid var(--church-blue)'}}>
              ...
              <button className="btn btn-gold" style={{marginTop: '20px', width: '100%', justifyContent: 'center'}}>
                Contact Leader
              </button>
            </div>
          </div>
