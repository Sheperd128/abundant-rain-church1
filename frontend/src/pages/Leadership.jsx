      ...
      <div className="container" style={{ padding: '80px 20px' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '60px', marginBottom: '120px' }}>
          ...
          <div style={{ flex: '2 1 500px' }}>
            ...
            <p style={text}>Since the early 1990s, Pastor Umanah has been a pioneering member of the Full Gospel Baptist Church in America. He is a respected voice across denominational lines and has been invited to speak at world conventions for Baptist, Lutheran, Methodist, Episcopal, Seventh-day Adventist, Oneness Apostolic, Mennonite, Anabaptist, and many other Christian denominations.</p>
